...
import { create, destroy, index, edit, show } from "@/routes/vendors"; // Assuming 'categories.show' is a named route
import { Head, Link } from '@inertiajs/vue3';
import { Button } from '@/components/ui/button';
import { router } from '@inertiajs/vue3';
import FlashMessages from '@/Components/FlashMessages.vue';
import { PaginatedVendors } from '@/types/vendors';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="p-3">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="">
                    <input type="text" v-model="search" placeholder="Search vendors"
            ...
            <div class="overflow-x-auto mt-2">
                ...
                <table class="w-full text-sm text-left text-gray-700">
                    ...
                    <tbody>
                        <tr v-for="vendor in vendors.data"
                            ...
                            <td class="px-6 py-2 font-medium text-gray-900">{{ vendor.id }}</td>
                            <td class="px-6 py-2 text-gray-700">{{ vendor.name }}</td>
                            <td class="px-6 py-2 space-x-1">
                                ...
                                <Button @click="deleteItem(vendor.id)"
                ...
                <nav class="flex justify-center mt-5" aria-label="Page navigation example">
                    <ul class="inline-flex -space-x-px text-sm">
                        <li v-for="link in props.vendors.links" :key="link.label" :disabled="!link.url">
